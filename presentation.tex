...
\begin{frame}{Résultats Unimodaux : Quantitative}
    \begin{table}[]
        ...
        \begin{tabular}{lcccc}
            ...
            \rowcolor{blue!15} \textbf{ViT-B/16 (Transformer)} & \textbf{0.231} & \textbf{0.096} & \textbf{0.069} & \textbf{0.151} \\
            ResNet50 (CNN) & 0.172 & 0.070 & 0.054 & 0.128 \\
            HSV (Couleur) & 0.143 & 0.041 & 0.032 & 0.105 \\
    ...
    \end{table}
    \begin{itemize}
        \item Supériorité des \textbf{Transformers} sur les CNN classiques.
        \item HSV reste le descripteur "bas-niveau" le plus performant.
    \end{itemize}
\end{frame}
